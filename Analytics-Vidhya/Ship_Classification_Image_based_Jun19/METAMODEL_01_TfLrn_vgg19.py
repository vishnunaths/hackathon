...
local_weights_file = r'V:\2019\WIP\AV_GamesOfDL_Image_Classification\vgg19_weights_tf_dim_ordering_tf_kernels.h5'

pre_trained_model = VGG19(include_top=True,input_shape=(224,224,3))
