...
local_weights_file = r'V:\Documents\Vishnu\Copy_that\inception_v3_weights_tf_dim_ordering_tf_kernels_notop.h5'
...
training_set = train_datagen.flow_from_directory('V:/Documents/Vishnu/Copy_that/Images_Train',
                                                 target_size = (128, 128),
                                                 batch_size = 32,
                                                 class_mode = 'categorical')

test_set = test_datagen.flow_from_directory('V:/Documents/Vishnu/Copy_that/Images_Validation',
                                            target_size = (128, 128),
                                            batch_size = 32,
                                            class_mode = 'categorical')
...
address_TrainTest = 'V:/Documents/Vishnu/Copy_that'
address_testImage = 'V:/Documents/Vishnu/Copy_that/Images_Test'
