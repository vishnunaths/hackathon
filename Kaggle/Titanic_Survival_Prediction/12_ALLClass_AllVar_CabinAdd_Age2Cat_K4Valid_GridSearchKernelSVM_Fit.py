...
X = datset_NamingAddress.iloc[:, [2,3,4,5,6,7,10,11]].values
y = datset_NamingAddress.iloc[:,1]

X_submission = datset_submission_NamingAddress.iloc[:, [1,2,3,4,5,6,9,10]].values
index_list = []
...
# Calculating Accuracy for the Random Forest Classifiers using K Fold
